...
function WiggleTitle({ textLines, emphasis = false }) {
  ...
  let cursor = 0;
  return (
    <div className="title-stack" onMouseEnter={startShuffle} onMouseLeave={stopShuffle}>
...
function VideoThumb({ src, poster, className, onOpen }) {
      ...
      >
        ...
        <section className="screen creative-screen">
          <div className="creative-block">
            <WiggleTitle textLines={["Creative"]} emphasis />
            <WiggleTitle textLines={["Human"]} emphasis />
            <button
        ...
        <section className="screen gallery-screen">
          <div className="video-layout">
            <VideoThumb
              className="tile-1"
              src="/videos/whoiskartik.mov"
              poster="/images/113.jpg"
              onOpen={(src) => {
                setActiveVideo(src);
                setShowReelOpen(true);
              }}
            ...
            <VideoThumb
              className="tile-2"
              src="/videos/artofnoticining.mov"
              poster="/images/artofnoticining.jpg"
              onOpen={(src) => {
                setActiveVideo(src);
                setShowReelOpen(true);
              }}
            ...
            <VideoThumb
              className="tile-3"
              src="/videos/cyprus-we're the people.mp4"
              poster="/images/cyprus-we're the people.jpg"
              onOpen={(src) => {
                setActiveVideo(src);
                setShowReelOpen(true);
              }}
            ...
            <VideoThumb
              className="tile-4"
              src="/videos/life moves pretty fast.mov"
              poster="/images/life moves pretty fast.jpg"
              onOpen={(src) => {
                setActiveVideo(src);
                setShowReelOpen(true);
              }}
            ...
            <VideoThumb
              className="tile-5"
              src="/videos/slice of maspalomas.mov"
              poster="/images/slice of maspalomas.jpg"
              onOpen={(src) => {
                setActiveVideo(src);
                setShowReelOpen(true);
              }}
            ...
            <VideoThumb
              className="tile-6"
              src="/videos/worldspinning.mp4"
              poster="/images/worldspinning.jpg"
              onOpen={(src) => {
                setActiveVideo(src);
                setShowReelOpen(true);
              }}
